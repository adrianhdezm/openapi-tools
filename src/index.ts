...
program
  ...
  .action(async (opts) => {
    ...
    const fileHeader = '// This file was generated by openapi-tools. Do not edit.\n';

    const renderedSchemas = Object.entries(schemas).map(([name, schema]) => {
    ...
    const content = [fileHeader, ...renderedSchemas].join('\n\n');
